...
library(flexdashboard) ; library(shiny) ; library(dplyr); library(tidyr);  library(forcats); library(stringr); library(htmlwidgets);  library(RcppRoll); library(plotly); library(shinythemes);library(leaflet); library(classInt); library(ggrepel); library(scales); library(leaflet.extras);

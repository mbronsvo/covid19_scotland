...
line_3 <- tibble( days = seq(0, max(ts$days)-30)) %>% 
...
Row 
-------------------------------------
### <strong>Trajectories of COVID-19.</strong></br>This is a plot of new cases against total cases on a log-log scale to emphasise the exponential trajectiories of outbreaks in each Health Board and highlight when these begin to slow down. 
